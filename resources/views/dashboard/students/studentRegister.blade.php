                        ...
                        <div class="col-lg-12">
                                    ...
                                    <div class="panel-heading">
                                        <a data-toggle="collapse" data-parent="#accordion" href="#collapse1"
                                           style="text-decoration: none;"><b>Choose
                                                Academic</b> </a>
                                        <a href="#" class="pull-right" id="show-class-info"><i
                            ...
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body" style="padding-bottom: 4px">
                                    <form action="{{url('/student/postStudentRegister')}}" method="POST"
                                          id="form-create-student"
                                          enctype="multipart/form-data">
                                        {!! csrf_field() !!}
                                        <input type="hidden" name="class_id" id="class_id">
                                        <input type="hidden" name="user_id" id="user_id" value="{{Auth::id()}}">
                                        <input type="hidden" name="dateregistred" id="dateregistred"
                                               value="{{date('Y-m-d')}}">
                                        <div class="row">
